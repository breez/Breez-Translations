...
class BreezTranslationsEs extends BreezTranslations {
  ...
  String home_config_backup_error(String provider) {
    return 'Breez ha detectado que la aplicación está utilizando una copia de seguridad antigua. Reinstale y restaure desde la copia de seguridad más reciente disponible en $provider.';
  }

  @override
  String home_config_backup_error_encrypted(String provider) {
    return 'Breez ha detectado que la aplicación está utilizando una copia de seguridad antigua. Reinstale y restaure desde la copia de seguridad más reciente disponible en $provider. Tenga en cuenta que no podrá restaurar Breez sin su clave de cifrado.';
  }
  ...
  @override
  String get backup_export_static => 'Exportar copia de seguridad estática';

  @override
  String get backup_export_static_error_data_missing => 'Archivo de respaldo no encontrado';
  ...
  @override
  String get handler_check_version_error_upgrading_servers => 'Breez actualmente está actualizando sus servidores. No podrá enviar o recibir fondos durante la actualización. Por favor, inténtelo de nuevo más tarde.';
  ...
  String lnurl_fetch_invoice_min(String min) {
    return 'Ingrese un valor entre $min';
  }
  ...
  @override
  String get podcast_action_layout => 'Disposición';
  ...
  @override
  String get valid_payment_error_exceeds_limit => 'El pago supera el límite.';
  ...
  @override
  String get moonpay_network_error => 'Hubo un error en la comunicación con Moonpay. Por favor, comprueba tu conexión y inténtalo de nuevo.';

  @override
  String get moonpay_retry_button => 'REINTENTAR';

  @override
  String moonpay_swap_in_progress(String address) {
    return 'Se ha detectado un intercambio en curso en la dirección $address. Espere hasta que se complete el intercambio.';
  }

  @override
  String get moonpay_swap_in_progress_action => 'Comprobar la transacción en el Mempool';

  @override
  String get moonpay_swap_expired => 'Se estaba realizando un intercambio, sin embargo, expiró, Breez está generando un reembolso para usted.';
